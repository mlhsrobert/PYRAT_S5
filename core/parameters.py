...
parser.add_argument('-x', '--width', type=int, metavar = "x", help='Width of the maze', default=27)
...
parser.add_argument('--matches', type=int, metavar = "matches", help='Number of matches (for statistics)', default=1)
...
parser.add_argument('--test_file', action="store_true", help='Save game to file in a good format for test')
